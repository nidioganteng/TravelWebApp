<x-admin-layout>
    ...
    <form x-data="{ items: {{ $travelRecord->items }} }" id="trackRecordForm" action="{{ route('admin.travel-records.update', $travelRecord->id) }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-8 lg:p-12">
        @csrf
        @method('PUT') 
